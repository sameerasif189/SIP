            ...
            {catIdx === 4 && (
              <div className="my-8 rounded-2xl overflow-hidden bg-[#1C3557] relative">
                ...
                <div className="p-7 relative z-10">
                  ...
                  <h3 className="text-white text-[22px] font-bold heading-font leading-tight mb-2 max-w-[70%]">
                    Bangle Stalls Are Coming To SiP
                  </h3>
                  <p className="text-white/55 text-[15px] leading-relaxed mb-5 max-w-[75%]">
                    Beautiful bangle stalls at SiP — this Thursday, 7 PM to 12 AM
                  </p>
                  <button className="bg-white/15 hover:bg-white/25 transition-colors text-white text-sm font-semibold px-5 py-2.5 rounded-full cursor-pointer">
                    Discover
                  </button>
                </div>
              </div>
            ...
            {(catIdx === 2 || catIdx === 5) && catIdx < menuData.length - 1 && (
              <div className="my-8 rounded-2xl overflow-hidden bg-[#1C3557] relative">
                ...
                <div className="p-6 relative z-10">
                  ...
                  <h3 className="text-white text-[20px] font-bold heading-font leading-tight mb-1.5 max-w-[70%]">
                    {catIdx === 2 ? "Alaaya Chand Raat Is Coming To SiP" : "Eid Brunch Is Coming To SiP"}
                  </h3>
                  <p className="text-white/55 text-sm leading-relaxed mb-4 max-w-[75%]">
                    {catIdx === 2
