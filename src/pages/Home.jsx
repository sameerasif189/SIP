...
import { Search, ShoppingBag, ChevronRight, UtensilsCrossed, CreditCard } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white pb-36">
      ...
      <div className="px-5 mb-4 max-w-lg mx-auto">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-3.5 rounded-2xl bg-bg border-none text-sm text-dark placeholder:text-muted focus:outline-none focus:ring-2 focus:ring-dark/10"
          />
        </div>
      </div>
          ...
          <div className="space-y-8">
            {menuData.map((category) => (
              ...
              >
                ...
                <div className="flex gap-4 overflow-x-auto scrollbar-hide sm:grid sm:grid-cols-2 sm:gap-x-4 sm:gap-y-6 pb-2 sm:pb-0">
      ...
      <AnimatePresence>
        {activeOrder && (
          <motion.div
            ...
            className="fixed bottom-36 left-4 right-4 z-40 max-w-lg mx-auto"
          >
      ...
      {/* Floating "View your order" bar - Sunday style */}
      <AnimatePresence>
        {totalItems > 0 && (
          <motion.div
            ...
            className="fixed bottom-16 left-4 right-4 z-50 max-w-lg mx-auto"
          >
            <Link
              to="/cart"
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-border">
        <div className="max-w-lg mx-auto flex">
          <button
            ...
            className={`flex-1 flex flex-col items-center gap-1 py-3 cursor-pointer transition-colors ${
              activeTab === "order" ? "text-dark" : "text-muted"
            }`}
          >
          ...
          <button
            onClick={() => { setActiveTab("pay"); navigate("/checkout"); }}
            className={`flex-1 flex flex-col items-center gap-1 py-3 cursor-pointer transition-colors ${
              activeTab === "pay" ? "text-dark" : "text-muted"
            }`}
          >
            <CreditCard size={20} />
